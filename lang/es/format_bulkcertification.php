...
/**
 * Strings for component 'format_bulkcertifications', language 'es'
 *
...
$string['page-course-view-topics'] = 'Alguna página principal en formato de certificación masiva';
$string['page-course-view-topics-x'] = 'Alguna página principal en formato de certificación masiva';
$string['hidefromothers'] = 'Ocultar sección';
$string['showfromothers'] = 'Mostrar sección';

$string['bulkcertification:manage'] = "Manejar parámetros globales del formato de certificación masiva";
$string['bulkcertification:deleteissues'] = "Borrar certificador dentro del formato de certificación masiva";

$string['wsuri'] = 'URI de WS';
$string['wsuser'] = 'Usuario del WS';
$string['wspassword'] = 'Clave del WS';
...
$string['code'] = 'Código';
$string['groupcode'] = 'Código de grupo (remoto) / material (local)';
$string['code_help'] = 'Código del material';
$string['groupcode_help'] = 'Código asociado al grupo si es un material remoto y el código del material si es local';
...
$string['objectiveslist'] = 'Datos a importar';
$string['import'] = 'Importar';
$string['delimiter'] = 'Delimitador';
$string['bulkobjectiveadd'] = 'Adicionar nuevos';
$string['bulkobjectivereplace'] = 'Reemplazar los existentes';
$string['bulkobjectivemode'] = 'Modo de importación';
$string['recordsdeleted'] = 'Se borraron los materiales existentes.';
...
$string['type_remote'] = 'Remoto';
$string['type_local'] = 'Local';
$string['objective_type'] = 'Tipo de material';
$string['userslist'] = 'Lista de usuarios';
$string['userslist_help'] = 'Las columnas obligatorias son: username, firstname, lastname, email. Además, se pueden agregar
columnas con nombres de campos de usuario personalizados, empezando por la palabra <em>profile_</em>';
$string['badfieldslength'] = 'La cantidad de campos es incorrecta en la fila: {$a}';
$string['badcolumnslength'] = 'La cantidad de columnas es incorrecta, se esperan {$a} columnas';
$string['badcolumns'] = 'Los nombres de las columnas son incorrectos';
